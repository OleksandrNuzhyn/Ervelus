        ...
        >
          <div class="flex flex-col p-3 sm:p-4 h-full">
              <div class="grid grid-cols-2 gap-2 h-full">
                <figure v-if="duo.input_img_signed_url" class="relative overflow-hidden rounded-xl ring-1 ring-white/10">
                  <img
                ...
                <figure v-else class="flex items-center justify-center rounded-xl ring-1 ring-white/10 h-full w-full">
                  <svg class="animate-spin h-8 w-8 text-white" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
                    <circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4"></circle>
                    <path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path>
                  </svg>
                </figure>
                <figure v-if="duo.output_img_signed_url" class="relative overflow-hidden rounded-xl ring-1 ring-white/10">
                  <img
