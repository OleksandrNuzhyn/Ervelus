...
const messages = {
  en: {
    ...
    workspace: {
      ...
      error_invalid_type: "Invalid file type. Our service support only JPEG, PNG or WEBP format",
      error_file_size: "Maximum file size is 7 MB",
      error_failed_spell: "The generation has failed! Try again",
      error_safety_rejected: "This image was rejected by the safety system. Try another image",
      ...
      error_free_disabled: "Free generations are temporarily unavailable. Purchase a package to get into the fast queue!",
      error_load_failed: "Failed to load dashboard data. Please try again later",
    ...
    profile: {
      ...
      promo_limit: "This promo code has reached its usage limit",
  ...
  uk: {
    ...
    workspace: {
      ...
      error_invalid_type: "Невірний тип файлу. Ми підтримуємо лише JPEG, PNG або WEBP",
      error_file_size: "Максимальний розмір файлу — 7 МБ",
      error_failed_spell: "Генерація не вдалася! Спробуйте ще раз",
      error_safety_rejected: "Це фото було відхилено системою безпеки. Спробуйте інше фото",
      ...
      error_free_disabled: "Безкоштовні генерації тимчасово недоступні. Купіть пакет, щоб потрапити в швидку чергу!",
      error_load_failed: "Не вдалося завантажити дані майстерні. Спробуйте пізніше",
    ...
    profile: {
      ...
      promo_not_found: "Такого промокоду не існує",
      promo_inactive: "Цей промокод більше не активний",
      promo_limit: "Ліміт використань цього промокоду вичерпано",
