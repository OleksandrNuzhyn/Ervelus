            ...
            <div class="relative z-10 flex flex-col h-full">
              ...
              <div class="mb-8 flex justify-center">
                <a href="https://discord.gg/38NV8t57th" target="_blank"
                  class="subscription-display-card !min-h-0 !py-6 !px-8 w-full max-w-2xl flex items-center justify-center gap-6 transition-all duration-300 group border border-[#5865F2]/20 hover:!border-[#5865F2]/50 hover:bg-[#5865F2]/5 no-underline">
