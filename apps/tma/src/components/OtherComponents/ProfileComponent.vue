<template>
  <div class="p-3 text-white h-full flex flex-col font-sans profile-container">
    <div class="flex-grow flex flex-col w-full max-w-[1850px] mx-auto space-y-8">
      <div class="py-2 flex-grow flex flex-col items-center">
            ...
            <div class="relative z-10 flex flex-col h-full">
              ...
              <div class="mb-8 flex justify-center">
                <a href="https://discord.gg/38NV8t57th" target="_blank"
                  class="profile-card !py-4 !px-8 min-h-[170px] w-full max-w-2xl flex flex-col items-center justify-center gap-4 transition-all duration-300 group border border-[#5865F2]/20 hover:!border-[#5865F2]/50 hover:bg-[#5865F2]/5 no-underline">
              ...
              <div class="mb-8 flex justify-center">
                <div class="profile-card !py-4 !px-8 min-h-[170px] w-full max-w-2xl flex flex-col items-center justify-center">
                  <div class="text-center mb-6">
                    <h3 class="text-xl font-bold text-gray-200 tracking-wide">{{ $t('profile.promo_title') }}</h3>
                    <p class="text-[10px] text-gray-400 mt-1 uppercase">{{ $t('profile.promo_placeholder') }}</p>
                  </div>
          ...
          <div class="pb-6 w-full max-w-2xl flex flex-col items-center">
            <div class="w-full profile-card !p-0 overflow-hidden mb-6">
            ...
            <p class="text-[11px] text-white/40 text-center font-medium tracking-wide pb-0">
