      ...
      <div class="py-2 flex-grow flex flex-col items-center">
          <div class="w-full max-w-2xl">
            <div class="relative z-10 flex flex-col h-full">
              ...
              <div class="mb-8 flex justify-center">
                <div class="profile-card !py-8 px-10 w-full max-w-2xl flex flex-col items-center">
                  <h3 class="text-xl font-bold text-gray-200 mb-4">{{ $t('profile.promo_title') }}</h3>
          ...
          <div class="pb-6 w-full max-w-2xl flex flex-col items-center">
            ...
            <p class="text-[11px] text-white/40 text-center font-medium tracking-wide pb-4">
