    ...
    <div @click.stop="selectStyle" class="relative cursor-default transition-all duration-200 ease-in-out transform hover:scale-105 active:scale-103 w-fit mx-auto">
      ...
      >
        ...
        <div 
          ...
          <div 
            class="absolute inset-0 transform blur-[2px] grayscale-[0.3]"
            :class="getSpriteClass()"
          ></div>
          
          <div class="absolute inset-0 bg-black/50"></div>

          <div class="absolute inset-0 flex items-center justify-center z-20">
            <div class="relative px-3 py-1.5 bg-black/60 backdrop-blur-md border border-white/5 rounded-full flex items-center gap-1.5 shadow-xl">
